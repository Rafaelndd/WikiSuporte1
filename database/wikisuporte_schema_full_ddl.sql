...
-- =========================================
-- INICIO BLOCO: database\migrations\20260911_indices_fk_faltantes.sql
-- =========================================
...
END $$;
-- =========================================
-- FIM BLOCO: database\migrations\20260911_indices_fk_faltantes.sql
-- =========================================

-- =========================================
-- INICIO BLOCO: database\migrations\20260911_usuarios_username_unique.sql
-- =========================================
-- usuarios.username é usada como credencial de login mas não tinha UNIQUE.
-- NOT NULL propositalmente não é adicionada: cadastro_usuarios.py grava
-- username = NULL de propósito quando o operador não informa um login
-- curto (login cai para o campo `nome` nesse caso).
DO $$
BEGIN
    IF NOT EXISTS (
...
END $$;
-- =========================================
-- FIM BLOCO: database\migrations\20260911_usuarios_username_unique.sql
-- =========================================
COMMIT;
